...
void InitializeCursorSpace(void) {
  ...
  for (i = 0; i < SpaceSize; i++) CursorSpace[i].Next = i + 1;
...
Position First(List L) { return CursorSpace[L].Next; }

Position Advance(Position P) { return CursorSpace[P].Next; }

ElementType Retrieve(Position P) { return CursorSpace[P].Element; }
